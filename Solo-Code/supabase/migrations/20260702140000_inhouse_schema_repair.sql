-- FK prerequisites (production had hollow tables missing PK/unique targets)
DELETE FROM public.profiles p
WHERE p.ctid NOT IN (
  SELECT MIN(p2.ctid) FROM public.profiles p2 GROUP BY p2.user_id
);
...
-- Repair hollow inhouse tables (migration 20260612120000 partially applied)
DROP TABLE IF EXISTS public.inhouse_canvases CASCADE;
DROP TABLE IF EXISTS public.inhouse_messages CASCADE;
DROP TABLE IF EXISTS public.inhouse_channels CASCADE;
DROP TABLE IF EXISTS public.inhouse_tasks CASCADE;
DROP TABLE IF EXISTS public.inhouse_workspace_members CASCADE;
DROP TABLE IF EXISTS public.inhouse_workspaces CASCADE;
DROP TABLE IF EXISTS public.inhouse_activity_events CASCADE;
DROP TABLE IF EXISTS public.inhouse_invites CASCADE;
DROP TABLE IF EXISTS public.inhouse_org_members CASCADE;
DROP TABLE IF EXISTS public.inhouse_orgs CASCADE;
...
CREATE TABLE public.inhouse_orgs (
...
CREATE TABLE public.inhouse_org_members (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE public.inhouse_workspaces (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  org_id uuid NOT NULL REFERENCES public.inhouse_orgs(id) ON DELETE CASCADE,
  name text NOT NULL,
  slug text NOT NULL,
...
CREATE TABLE public.inhouse_workspace_members (
...
CREATE TABLE public.inhouse_tasks (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  workspace_id uuid NOT NULL REFERENCES public.inhouse_workspaces(id) ON DELETE CASCADE,
  title text NOT NULL,
  description text,
...
CREATE TABLE public.inhouse_channels (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  workspace_id uuid NOT NULL REFERENCES public.inhouse_workspaces(id) ON DELETE CASCADE,
  name text NOT NULL,
...
CREATE TABLE public.inhouse_messages (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE TABLE public.inhouse_activity_events (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  org_id uuid NOT NULL REFERENCES public.inhouse_orgs(id) ON DELETE CASCADE,
...
CREATE TABLE public.inhouse_invites (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  org_id uuid NOT NULL REFERENCES public.inhouse_orgs(id) ON DELETE CASCADE,
...
CREATE TABLE public.inhouse_canvases (
  id uuid PRIMARY KEY DEFAULT gen_random_uuid(),
  workspace_id uuid NOT NULL REFERENCES public.inhouse_workspaces(id) ON DELETE CASCADE,
