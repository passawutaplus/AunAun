...
const CommunityGuidelinesPage = () => (
  <LegalLayout title="กฎชุมชนและการดูแลความปลอดภัย">
    ...
    <h2>1.1 กระดานชุมชน (Forum)</h2>
    <p>
      ฟอรัมที่ <a href="/forum">/forum</a> มีไว้คุยเรื่องแพลตฟอร์ม {LEGAL_APP_NAME} แจ้งปัญหา
      เสนอไอเดีย และช่วยกันพัฒนาไปด้วยกัน — รวมถึงประกาศจากทีมพัฒนา
    </p>
    <ul>
      <li>
        <strong>ห้ามลงหางาน / ประกาศจ้าง / รับสมัครงาน</strong> ในฟอรัม —
        ใช้หน้า <a href="/jobs">โอกาส</a> แทน
      </li>
      <li>ค้นหาก่อนโพสต์ เลือกหมวดให้ถูก และเคารพผู้อื่น</li>
      <li>อย่าเปิดเผยข้อมูลส่วนตัวหรือบัญชี</li>
      <li>หมวด “ประกาศจากทีม” โพสต์ได้เฉพาะทีมงาน</li>
    </ul>
    ...
    <h2 id="ai">2.1 ผลงานที่ใช้ AI</h2>
    <p>
      {LEGAL_APP_NAME} อนุญาตให้ลงผลงานที่ใช้ AI ได้
      แต่ชุมชนนี้ขายความน่าเชื่อถือของผลงานจริง — คนจ้างต้องรู้ว่างานมือแค่ไหน
    </p>
    <p>
      <strong>ต้องทำ:</strong> ถ้าใช้ AI แม้แค่ขึ้นต้นแบบหรือแต่งภาพ ให้เปิดสวิตช์ แล้วเลือก 1 ใน 3 ระดับ
      เลือกให้ตรงงาน ไม่เลือกเบาเพื่อให้ดูเป็นงานมือ
    </p>
    <ul>
    ...
    <p>
      <strong>ห้าม:</strong> ลงงานที่ใช้ AI แล้วปิดสวิตช์, เลือก “ช่วยทำ” ทั้งที่เจนทั้งภาพ,
      เอาผลงาน AI ของคนอื่นมาลงแล้วอ้างว่าเป็นของตน,
      หรือใช้ AI เลียนแบบสไตล์ครีเอเตอร์คนอื่นจนเข้าใจผิดว่าเป็นงานต้นฉบับของเขา
    </p>
    <p>
      ไม่เลือก = คุณยืนยันว่าไม่ได้ใช้ AI เลย
      ครั้งแรกที่ผิดกติกา ทีมอาจซ่อนผลงานแล้วให้แก้แท็ก
      ทำซ้ำหรือจงใจปกปิดจะดำเนินการตามกฎชุมชน
      ถ้าพบงานที่ไม่เปิดเผย AI ให้รายงานด้วยเหตุผล “ไม่เปิดเผยการใช้ AI / เลือกระดับไม่ตรงงาน”
    </p>
