        ...
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between gap-2">
          ...
          {isOwner ? (
            <div className="flex items-center gap-1 shrink-0">
              <Button size="sm" variant="outline" className="rounded-full h-8 px-2.5" onClick={() => setEditOpen(true)}>
                <Pencil className="w-3.5 h-3.5" />
                <span className="hidden sm:inline ml-1">แก้ไข</span>
              </Button>
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button size="sm" variant="outline" className="rounded-full h-8 px-2.5 text-destructive hover:text-destructive">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        {isLoading ? (
          ...
          <div className="text-center py-20 glass-panel rounded-2xl space-y-3">
            ...
            <p className="text-sm text-muted-foreground">เลื่อนดูฟีดแล้วกด Inspire บนภาพเพื่อเก็บเข้านี่</p>
          ...
          <>
            ...
            <AnimatedDensityGrid
              ...
              layoutGroupId="inspire-items-layout"
            >
              {items.map((it) => {
