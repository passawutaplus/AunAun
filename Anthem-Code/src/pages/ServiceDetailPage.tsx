 ...
 * Mobile stack + sticky CTA; tablet/desktop two-column via ServiceDetailView.
 */
  ...
  return (
    <div className="min-h-screen bg-app-ambient pb-28 md:pb-8">
      ...
      <main className="mx-auto max-w-5xl">
        ...
        {ownerProfile?.username || service.owner_id ? (
          <p className="px-4 py-4 text-center text-xs text-muted-foreground md:px-5">
            <Link
              to={`/u/${ownerProfile?.username || service.owner_id}?tab=services`}
