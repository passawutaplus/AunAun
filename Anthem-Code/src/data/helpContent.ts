    ...
    articles: [
      {
        ...
        body: [
          ...
          "ถ้าใช้ AI แม้แค่ขึ้นต้นแบบ ต้องเปิดสวิตช์แล้วเลือกระดับให้ตรงงาน — คนดูจะเห็นป้ายบนการ์ด",
        ],
        steps: [
          ...
          "ถ้าใช้ AI ให้เปิดสวิตช์แล้วเลือก ช่วยทำ / ส่วนหนึ่ง / AI 100%",
        ...
        popular: true,
        keywords: ["ลงผลงาน", "ชิ้นแรก", "พอร์ตโฟลิโอ", "publish", "AI"],
      },
      {
    ...
    articles: [
      ...
      },
      {
        ...
        body: [
          ...
          "ถ้าผลงานใช้ AI แต่ไม่ติดแท็ก หรือเลือกระดับไม่ตรงงาน เลือกเหตุผล “ไม่เปิดเผยการใช้ AI”",
      ...
      },
      {
        ...
        body: [
          ...
          "อ่านหน้าทรัพย์สินทางปัญญาเพื่อเข้าใจความรับผิดชอบตอนลงผลงาน — รวมงานลูกค้าที่ต้องได้รับอนุญาตให้โชว์ก่อน",
        ],
        links: [
