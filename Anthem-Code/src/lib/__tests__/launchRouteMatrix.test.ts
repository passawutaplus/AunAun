...
const APP_ROUTE_SAMPLES: { path: string; launchEnabled: boolean }[] = [
  ...
  { path: "/help/portfolio/first-project", launchEnabled: true },
  { path: "/forum", launchEnabled: true },
  { path: "/forum/new", launchEnabled: true },
  { path: "/hire/start", launchEnabled: true },
  { path: "/verify", launchEnabled: true },
  ...
  { path: "/dashboard/collab", launchEnabled: true },
  ...
  { path: "/legal/kyc-aml", launchEnabled: true },
  { path: "/earnings", launchEnabled: true },
