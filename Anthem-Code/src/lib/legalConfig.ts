...
export const LEGAL_UPDATED_AT =
  (import.meta.env.VITE_LEGAL_UPDATED_AT as string | undefined) ?? "14 สิงหาคม 2569";

/** รุ่นข้อความคำแถลงการยืนยันลิขสิทธิ์ — เก็บใน projects.rights_attestation_version */
export const LEGAL_ATTESTATION_VERSION =
  (import.meta.env.VITE_LEGAL_ATTESTATION_VERSION as string | undefined) ?? "2026-08-14";

/** รุ่นนโยบายที่ใช้บันทึก consent — sync กับ anthem.policy_versions */
export const LEGAL_TERMS_VERSION =
  (import.meta.env.VITE_LEGAL_TERMS_VERSION as string | undefined) ?? "2026-08-14";


export const LEGAL_PRIVACY_VERSION =
  (import.meta.env.VITE_LEGAL_PRIVACY_VERSION as string | undefined) ?? "2026-07-24";
