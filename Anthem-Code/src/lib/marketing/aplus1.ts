...
export const MARKETING_APLUS1_DEFAULT_BUSINESS = {
...
export const MARKETING_APLUS1_PROMPT_TASKS = [
...
export const MARKETING_APLUS1_METRICS = {
  creatorLeads: 428,
  hiringLeads: 186,
  studioSignals: 52,
...
export function marketingBrandSubtitle(lang: "th" | "en"): string {
  if (lang === "en") {
...
export function marketingBrandDescription(lang: "th" | "en"): string {
  if (lang === "en") {
