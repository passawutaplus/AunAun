...
export const UPLOAD_STAGE = {
  ...
  uploadingImage: "กำลังอัปโหลดรูปภาพขึ้นเซิร์ฟเวอร์...",
  uploadingVideo: "กำลังอัปโหลดวิดีโอขึ้นเซิร์ฟเวอร์...",
  uploadingGif: "กำลังอัปโหลด GIF ขึ้นเซิร์ฟเวอร์...",
  uploadingModel3d: "กำลังอัปโหลดไฟล์ 3D ขึ้นเซิร์ฟเวอร์...",
} as const;
