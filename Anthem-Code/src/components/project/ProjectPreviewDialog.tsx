...
const ProjectPreviewDialog = ({ open, onOpenChange, data, ownerId }: Props) => {
      ...
      <DialogContent className="max-w-7xl w-[calc(100vw-1.5rem)] h-[min(92vh,900px)] p-0 gap-0 flex flex-col overflow-hidden">
        <div className="flex items-center justify-between gap-3 px-4 py-3 border-b border-border shrink-0">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <Badge variant="outline" className="text-[10px] shrink-0">ตัวอย่าง</Badge>
          </div>
        ...
        <div className="flex-1 overflow-y-auto bg-app-ambient">
