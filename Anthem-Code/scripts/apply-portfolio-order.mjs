#!/usr/bin/env node
/** Apply 20260607210000_project_portfolio_order.sql on remote. */
...
const SQL_PATH = join(root, "supabase/migrations/20260607210000_project_portfolio_order.sql");
...
async function main() {
  ...
  console.log("✓ Applied project_portfolio_order migration");
}
